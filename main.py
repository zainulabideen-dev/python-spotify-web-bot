...
def login(e, p, a):
    ...
    try:
        btnLogin = WebDriverWait(driver, delay).until(EC.presence_of_element_located((By.XPATH, '//button[@class="Qt5xfSWikz6CLU8Vobxs jzic9t5dn38QUOYlDka0"]')))
        btnLogin.click()
